...
(
    ...
    `usermobile`    varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户电话号码',
    `is_admin`      tinyint                                                 NOT NULL DEFAULT '0' COMMENT '是否为管理员',
    `remarks`       varchar(64)                                                      DEFAULT NULL COMMENT '备注',
    `lasttime`      timestamp                                                        DEFAULT NULL COMMENT '上次访问时间',
    `search_device` varchar(100)                                                     DEFAULT NULL COMMENT '上次访问的设备',
    `comname`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公司名称',
    `comarea`       varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci          DEFAULT NULL COMMENT '公司地址',
